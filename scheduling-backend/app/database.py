...
async def run_migrations(conn):
    ...
    migrations = [
        ...
        ("fees", "charge_per_hour", "BOOLEAN DEFAULT 0"),
        ("expedite_requests", "fee_acknowledged", "BOOLEAN DEFAULT 0"),
        ("expedite_requests", "fee_acknowledged_at", "DATETIME"),
        ("expedite_requests", "fee_acknowledged_by_user_id", "INTEGER"),
